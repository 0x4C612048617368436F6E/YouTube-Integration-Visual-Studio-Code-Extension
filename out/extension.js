...
class YoutubeIntegration {
    ...
    getAllLocalResources(webviewView) {
        ...
        const hamburger_menu = vscode.Uri.joinPath(this._extensionUri, "media", "../resources/hamburger-menu.svg");
        ...
        const header = vscode.Uri.joinPath(this._extensionUri, "media", "../resources/styles/header.css");
        //get special URI to use with webview
        const header_src = webviewView.webview.asWebviewUri(header);
        //below is for video css
        const video = vscode.Uri.joinPath(this._extensionUri, "media", "../resources/styles/video.css");
        //get special URI to use with webview
        const video_src = webviewView.webview.asWebviewUri(video);
        //below is for sidebar css
        const sidebar = vscode.Uri.joinPath(this._extensionUri, "media", "../resources/styles/sidebar.css");
        //get special URI to use with webview
        const sidebar_src = webviewView.webview.asWebviewUri(sidebar);
        //below is for youtube logo
        const youtube_logo = vscode.Uri.joinPath(this._extensionUri, "media", "../resources/youtube-logo.svg");
        //get special URI to use with webview
        const youtube_logo_src = webviewView.webview.asWebviewUri(youtube_logo);
        //below is for search
        const search = vscode.Uri.joinPath(this._extensionUri, "media", "../resources/search.svg");
        //get special URI to use with webview
        const search_src = webviewView.webview.asWebviewUri(search);
        //below is for voice search icon
        const voice_search_icon = vscode.Uri.joinPath(this._extensionUri, "media", "../resources/voice-search-icon.svg");
        //get special URI to use with webview
        const voice_search_icon_src = webviewView.webview.asWebviewUri(voice_search_icon);
        //below is for upload
        const upload = vscode.Uri.joinPath(this._extensionUri, "media", "../resources/upload.svg");
        //get special URI for upload
        const upload_src = webviewView.webview.asWebviewUri(upload);
        //below is for youtube_apps
        const youtube_apps = vscode.Uri.joinPath(this._extensionUri, "media", "../resources/youtube-apps.svg");
        ...
        const notifications = vscode.Uri.joinPath(this._extensionUri, "image", "../resources/notifications.svg");
    ...
    returnHTML(webviewView) {
        let [hamburger_menu, general, header, video, sidebar, youtube_logo, search, voice_search_icon, upload, youtube_apps, notifications,] = this.getAllLocalResources(webviewView);
        return `<!DOCTYPE html>
<html>
    <head>
        <title>
