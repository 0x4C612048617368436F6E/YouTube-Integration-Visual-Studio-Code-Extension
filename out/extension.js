...
function activate(context) {
    ...
    const disposable = vscode.commands.registerCommand("youtubeintegration.YoutubeIntegration", () => {
        ...
        vscode.window.showInformationMessage("Welcome to the YouTube Integreation");
    });
    const disposable2 = vscode.commands.registerCommand("youtubeintegration.currentTime", () => {
